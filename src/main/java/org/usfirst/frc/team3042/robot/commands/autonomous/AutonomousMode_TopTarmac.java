...
public class AutonomousMode_TopTarmac extends SequentialCommandGroup {

  public AutonomousMode_TopTarmac() {
    addCommands(new Conveyor_Run(1), new Wait(3), new Conveyor_Run(0),
                ...
                new Drivetrain_Trajectory("Top2_Path1"),
